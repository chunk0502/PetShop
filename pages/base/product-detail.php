                    ...
                    <!-- <div class="col p-relative" style="--w-md: 6">
                        <div class="product-detail__media">
                            <div class="media__items d-flex">
                                <div style="display: grid; place-items: center;  height: 50vh; " class="media__item product-image-container w-100">
                                    <img style="  max-width: 70%" src="admin/modules/product/uploads/<?php echo $row_product_detail['product_image'] ?>" alt="image product" />
                            ...
                            <form method="POST" action="pages/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                                ...
                                <div class="product-detail__variants">
                                    <div class="product-detail__variant">
                                        <h3 class="product-detail__variant--title h6">Size</h3>
                                        <div class="product-detail__variant--items d-flex">
                                            <?php foreach ($capacity_names as $index => $name): ?>
                                                <input class="custom-radio" type="radio" name="product_size" id="size_<?php echo $index; ?>" value="<?php echo $name; ?>" <?php echo $index === 0 ? 'checked="checked"' : ''; ?> />
                                ...
                                <?php if ($row_product_detail['product_quantity'] > 0) { ?>
                                    ...
                                    <input class="btn product-detail__buynow w-100" style="background-color: blue;border-color: blue;border-radius: 20px" type="submit" name="buynow" value="Mua ngay" />
                                <?php } else { ?>
                    ...
                    <div class="evaluate__content">
                        ...
                        while ($evaluate = mysqli_fetch_array($query_evaluate)) {
                            ...
                            <div class="comment-item d-flex">
                                <div class="f-cmuser"><abbr title="localhost:"><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
