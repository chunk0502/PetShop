                ...
                <div class="product__sidebar">
                    <div class="sidebar__item w-100">
                        <div class="sidebar__item--heading">
                            <h3 class="h3">Loại sản phẩm</h3>
                        </div>
                        ...
                        <div class="sidebar__item--content">
                            <div class="sidebar__item--content">
                                ...
                                while ($brands = mysqli_fetch_array($query_brands)) {
                                    ?>
                                    <a style="background-color: white; color: black" href="index.php?page=products&brand_id=<?php echo $brands['brand_id'];
                                    echo $url_price;
                                    echo $url_sort; ?>" class="sidebar__item--label d-block <?php if (isset($_GET['brand_id']) && $brands['brand_id'] == $_GET['brand_id']) {
                                        echo 'category__active';
                                    } ?>" for="1">
                        ...
                        <div class="col" style="--w: 9; --w-md: 4">
                            <div class="product__card d-flex flex-column">
                                <div class="product__image p-relative">
                                    <a style="display: grid; place-items: center;" href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
