            ...
            <a href="index.php?page=order_detail&order_code=<?php echo $order['order_code'] ?>">
                <div class="order__item">
                    ...
                    <div class="order__container">
                        <?php
                        $sql_order_detail_list = "SELECT od.order_detail_id, p.product_id, p.product_name, od.product_quantity, od.product_price, od.product_sale, p.product_image, od.size FROM order_detail od JOIN product p ON od.product_id = p.product_id WHERE od.order_code = '" . $order['order_code'] . "' ORDER BY od.order_detail_id DESC";
                        ...
                        <div class="cart__item d-flex align-center">
                            ...
                            <div class="flex-1">
                                ...
                                <h3 class="cart__name h4">Loại: <?php echo $order_detail['size'] ?></h3>
                            </div>
