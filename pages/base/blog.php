...
?>
<!-- start blog -->
<section class="blog pd-section" style="margin: 20px; max-width: 1000px; margin-left: 200px">
    <div>
        <h1 style="text-align: center; margin-top: 0; color:#b09900; font-weight: bold; margin-bottom: 50px">BLOG TYRA</h1>
