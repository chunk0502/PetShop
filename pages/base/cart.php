                    ...
                    ?>
                            <div class="cart__item d-grid" >
                                ...
                                <div class="cart__title">
                                    ...
                                    <h4 style="white-space: nowrap" class="cart__name h4">Loại: <?php echo $cart_item['size']; ?></h4>
                                </div>
                                <div class="cart__quantity">
...
if ($validate == true) {
?>
    <a href="index.php?page=checkout" class="btn cart__btn btn__solid text-center" style="background-color: blue; border-radius: 20px; border-color: #22B24C;">Tiến hành đặt hàng</a>
<?php 
} else { 
?>
    <button style="background-color: blue; border-radius: 20px; border-color: #22B24C;" class="btn cart__btn btn__solid text-center opacity-50" onclick="showErrorMessage();">Tiến hành đặt hàng</button>
<?php 
} 
?>
