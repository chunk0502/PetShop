        ...
        <div class="card">
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="?action=article&query=article_search" method="POST">
                            <i class="icon-search p-absolute"></i>
                            <input type="search" class="form-control" title="Nhập vào tên tài khoản để tìm kiếm" name="article_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
