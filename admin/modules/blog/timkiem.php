...
$sql_article_list = "SELECT * FROM article WHERE article_title LIKE '%" . $keyword . "%'";
            ...
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên khách hàng để tìm kiếm" name="article_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
