        ...
        <div class="card">
            <div class="card-body">
                <div class="main-pane-top" style="display: flex; justify-content: space-between; align-items: center; padding: 0 15px;">
                    ...
                    <form class="search-form" action="?action=customer&query=customer_search" method="POST">
                            <i class="icon-search p-absolute"></i>
                            <input type="search" class="form-control" title="Nhập vào tên tài khoản để tìm kiếm" name="customer_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                    <!--số tài khoản bên phải -->
                    <div class="customer-info" style="display: flex; justify-content: flex-end; align-items: center;">
                        <h3 class="box-title" style="margin: 0; padding-right: 10px;">Số lượng khách hàng</h3>
                        <span class="box-number color-t-red" style="font-size: 16px;"><?php echo $customer_count ?></span>
                    </div>
                </div>
