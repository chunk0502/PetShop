<?php
if (isset($_POST['brand_search'])) {
    $keyword = $_POST['brand_search'];
}
$sql_brand_list = "SELECT * FROM brand WHERE brand_name LIKE '%" . $keyword . "%'";
            ...
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên khách hàng để tìm kiếm" name="brand_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
