<?php
if (isset($_POST['capacity_search'])) {
    $keyword = $_POST['capacity_search'];
}
$sql_capacity_list = "SELECT * FROM capacity WHERE capacity_name LIKE '%" . $keyword . "%'";
            ...
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên khách hàng để tìm kiếm" name="capacity_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
