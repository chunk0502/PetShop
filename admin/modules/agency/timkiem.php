<?php
if (isset($_POST['agency_search'])) {
    $keyword = $_POST['agency_search'];
}
$sql_agency_list = "SELECT * FROM agency WHERE 'name' LIKE '%" . $keyword . "%'";
            ...
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên thương hiệu để tìm kiếm" name="agency_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
