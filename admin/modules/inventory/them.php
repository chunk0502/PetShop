                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="display: flex; align-items: center; justify-content: space-between;">
                                            <p class="receipt__info--company" style="margin-right: 20px;">Tên đơn vị cung cấp:</p>
                                            <select class="receipt__info--input" name="supplier_name" required style="flex-grow: 1;  border: 1px solid #ccc; border-radius: 4px;">
                                                <option value="" disabled selected>Chọn</option> <!-- Option mặc định -->
                                                <?php
                                                // Truy vấn các đơn vị cung cấp từ cơ sở dữ liệu
                                                $sql_supplier_list = "SELECT * FROM inventory ORDER BY supplier_name ASC";
                                                $query_supplier_list = mysqli_query($mysqli, $sql_supplier_list);
                                                
                                                // Hiển thị danh sách các đơn vị cung cấp
                                                while ($row_supplier = mysqli_fetch_array($query_supplier_list)) {
                                                    ?>
                                                    <option value="<?php echo $row_supplier['supplier_name']; ?>"><?php echo $row_supplier['supplier_name']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    if (isset($_SESSION['inventory'])) {
                                        ...
                                        foreach ($_SESSION['inventory'] as $inventory_item) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $i ?></td>
                                        <td><?php echo $inventory_item['product_id'] ?></td>
