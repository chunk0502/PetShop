...
if (isset($_POST['inventory_search'])) {
    $keyword = $_POST['inventory_search'];
}
$sql_inventory_list = "SELECT * FROM inventory WHERE staf_name LIKE '%" . $keyword . "%'";
            ...
            <div class="card-body">
                <div class="main-pane-top d-flex justify-center align-center">
                    ...
                    <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên khách hàng để tìm kiếm" name="inventory_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                </div>
