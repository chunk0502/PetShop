...
<nav style="background-color: #22B24C !important;" class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row" >
    <div  class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color:blue;">
        <div class="me-3">
        ...
        <div>
            <a  class="navbar-brand brand-logo" href="index.php?action=home&query" style="font-size: 30px;font-weight: bold; color:white;">
                <!-- <img src="images/logoadmin.png" alt="logo" /> -->
                TYRA
            </a>
        </div>
    </div>
    <div  class="navbar-menu-wrapper d-flex align-items-top" style="background-color: blue; margin-bottom: 0px;">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text" style="margin: 0px; color: white">Xin chào, <span style="color: white" class="text-black fw-bold"><?php if (isset($_SESSION['account_name'])) { echo $_SESSION['account_name']; } ?></span></h1>
            </li>
        </ul>
