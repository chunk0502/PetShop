                    ...
                    <div class="card-body">
                        <div class="card-content">
                            ...
                            <div class="input-item form-group">
                                ...
                                <input type="date" name="product_date" class="d-block form-control" value="<?php echo $row['product_date'] ?>" />
                            </div>
                            <div class="input-item form-group">
                                <label for="product_expiry" class="d-block">Ngày hết hạn</label>
                                <input type="date" name="product_expiry" class="d-block form-control" value="<?php echo $row['product_expiry'] ?>" />
                            </div>
                            <div class="input-item form-group">
                                <label for="product_warranty" class="d-block">Thời gian bảo hành</label>
                                <input type="number" name="product_warranty" class="d-block form-control" value="<?php echo $row['product_warranty'] ?>" placeholder="Thời gian bảo hành (tháng)" />
                            </div>
