<?php
    ...
    $sheet->setCellValue('B1', 'Gía nhập vào');
    $sheet->setCellValue('C1', 'Gía bán ra');
    $sheet->setCellValue('D1', 'Số lượng tồn kho');
    ...
    if(mysqli_num_rows($query_product) > 0){
        ...
        while($row = mysqli_fetch_array($query_product)){
            ...
            $sheet->setCellValue('D' . $rowIndex, $row['product_quantity']);
            $rowIndex++;
        }
    } else {
    ...
    $fileName = 'soluongtonkho-data_' . date('Y-m-d') . '.xlsx';
