...
// Lấy giá trị của 3 trường mới
$product_date = isset($_POST['product_date']) ? $_POST['product_date'] : null;
$product_expiry = isset($_POST['product_expiry']) ? $_POST['product_expiry'] : null;
$product_warranty = isset($_POST['product_warranty']) ? $_POST['product_warranty'] : null;

if (isset($_POST['product_add'])) {
    // Thêm sản phẩm
    $sql_add = "INSERT INTO product(product_name, product_category, product_brand, capacity_id, product_price_import, product_price, product_sale, product_description, product_image, product_images, product_status, product_date, product_expiry, product_warranty) 
                VALUES('" . $product_name . "', '" . $product_category . "', '" . $product_brand . "', '" . $product_capacity_str . "', '" . $product_price_import . "', '" . $product_price . "', '" . $product_sale . "', '" . $product_description . "', '" . $product_image . "', '" . $product_images_string . "', '" . $product_status . "', '" . $product_date . "', '" . $product_expiry . "', '" . $product_warranty . "')";
    ...
    if ($_FILES['product_image']['name'] != '') {
        ...
        $sql_update = "UPDATE product SET product_name = '" . $product_name . "', product_brand = '" . $product_brand . "', capacity_id = '" . $product_capacity_str . "', product_category = '" . $product_category . "', 
                       ...
                       product_image = '" . $product_image . "', product_images = '" . $product_images_string . "', product_status = '" . $product_status . "', product_date = '" . $product_date . "', product_expiry = '" . $product_expiry . "', product_warranty = '" . $product_warranty . "' WHERE product_id = '" . $product_id . "'";
    } else {
        $sql_update = "UPDATE product SET product_name = '" . $product_name . "', product_brand = '" . $product_brand . "', capacity_id = '" . $product_capacity_str . "', product_category = '" . $product_category . "', 
                       product_price_import = '" . $product_price_import . "', product_price = '" . $product_price . "', product_sale = '" . $product_sale . "', product_description = '" . $product_description . "', 
                       product_images = '" . $product_images_string . "', product_status = '" . $product_status . "', product_date = '" . $product_date . "', product_expiry = '" . $product_expiry . "', product_warranty = '" . $product_warranty . "' WHERE product_id = '" . $product_id . "'";
    }
