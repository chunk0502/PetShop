        ...
        <div class="card">
            <div class="card-body">
                <div class="main-pane-top" style="display: flex; justify-content: space-between; align-items: center; padding: 0 15px;">
                    ...
                    <div class="customer-info" style="display: flex; justify-content: flex-end; align-items: center;">
                        <h3 class="box-title" style="margin: 0; padding-right: 10px;">Số lượng sản phẩm</h3>
                        <span class="box-number color-t-red" style="font-size: 16px;"><?php echo $product_count ?></span>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo !empty($row['product_date']) ? date("d/m/Y", strtotime($row['product_date'])) : 'Chưa có dữ liệu'; ?>
                                    </td>
                                    <td>
                                        <?php echo !empty($row['product_expiry']) ? date("d/m/Y", strtotime($row['product_expiry'])) : 'Chưa có dữ liệu'; ?>
                                    </td>
                                    <td>
                                        <?php echo !empty($row['product_warranty']) ? $row['product_warranty'] . ' tháng' : 'Chưa có dữ liệu'; ?>
                                    </td>
                                </tr>
                            <?php
                            }
