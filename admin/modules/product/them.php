                ...
                <div class="card-body">
                    <div class="card-content">
                        <div class="input-item form-group">
                            ...
                            <input type="text" id="product_name" name="product_name" class="d-block form-control" value="" placeholder="Nhập tên sản phẩm" required>
                        ...
                        <div class="input-item form-group">
                            <label for="product_capacity" class="d-block">Trọng Lượng</label>
                        ...
                        <div class="input-item form-group">
                            <label for="product_date" class="d-block">Ngày sản xuất</label>
                            <input type="date" id="product_date" name="product_date" class="d-block form-control" >
                            <span class="form-message"></span>
                        </div>
                        <div class="input-item form-group">
                            <label for="product_expiry" class="d-block">Hạn sử dụng</label>
                            <input type="date" id="product_expiry" name="product_expiry" class="d-block form-control" >
                            <span class="form-message"></span>
                        </div>
                        <div class="input-item form-group">
                            <label for="product_warranty" class="d-block">Thời gian bảo hành</label>
                            <input type="number" id="product_warranty" name="product_warranty" class="d-block form-control" placeholder="Thời gian bảo hành (tháng)" >
                            <span class="form-message"></span>
                        </div>
                    </div>
                </div>
