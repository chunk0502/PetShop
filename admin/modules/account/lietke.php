...
if (isset($_POST['account_keyword'])) {
    ...
    $query_account = mysqli_query($mysqli, "SELECT * FROM account");
    $account_count = mysqli_num_rows($query_account);
    ...
    <div class="col">
        <div class="header__list d-flex space-between align-center">
            ...
            <div class="action_group">
                <a href="?action=account&query=account_add" class="button button-dark">Thêm nhân sự</a>
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                <div class="main-pane-top" style="display: flex; justify-content: space-between; align-items: center; padding: 0 15px;">

                    <div class="input__search p-relative" style="flex: 1; margin-right: 15px;">
                    <form class="search-form" action="?action=account&query=account_search" method="POST">
                            <i class="icon-search p-absolute"></i>
                            <input type="search" class="form-control" title="Nhập vào tên tài khoản để tìm kiếm" name="account_search" placeholder="Search Here" title="Search here">
                        </form>
                    </div>
                    <!--số tài khoản bên phải -->
                    <div class="account-info" style="display: flex; justify-content: flex-end; align-items: center;">
                        <h3 class="box-title" style="margin: 0; padding-right: 10px;">Số tài khoản</h3>
                        <span class="box-number color-t-red" style="font-size: 16px;"><?php echo $account_count ?></span>
                    </div>
                </div>
